...
public class S3Config {
	...
	public AmazonS3 amazonS3() {
		AWSCredentials credencias = new BasicAWSCredentials(property.getS3().getAccessKeyId(),
				property.getS3().getSecretAccessKeyId());
		...
		if (!amazonS3.doesBucketExistV2(property.getS3().getBucket())) {
			...
			BucketLifecycleConfiguration.Rule regraExpiracao =
					...
					.withId("Regra de expiração de arquvios temporário")
