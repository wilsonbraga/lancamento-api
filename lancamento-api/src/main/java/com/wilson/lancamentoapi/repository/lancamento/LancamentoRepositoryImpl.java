...
import com.wilson.lancamentoapi.model.Categoria_;
import com.wilson.lancamentoapi.model.Lancamento;
import com.wilson.lancamentoapi.model.Lancamento_;
import com.wilson.lancamentoapi.model.Pessoa_;
...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery {
	...
	public List<LancamentoEstatisticaSoma> somaTipo(BigDecimal soma) {
				...
				CriteriaQuery<LancamentoEstatisticaSoma> criteriaQuery = criteriaBuilder
						.createQuery(LancamentoEstatisticaSoma.class);

				Root<Lancamento> root = criteriaQuery.from(Lancamento.class);
				
				criteriaQuery.select(criteriaBuilder.construct(LancamentoEstatisticaSoma.class,
					root.get(Lancamento_.tipo),
					criteriaBuilder.sum(root.get(Lancamento_.valor))));
				...
				TypedQuery<LancamentoEstatisticaSoma> typedQuery = manager
						.createQuery(criteriaQuery);
	...
	private void adicionarRestricoesDePaginacao(TypedQuery<?> query, Pageable pageable) {
		int pagianaAtual = pageable.getPageNumber();
		int totalRegistroPagina = pageable.getPageSize();
		int primeiroRegistroDaPagina = pagianaAtual * totalRegistroPagina;
